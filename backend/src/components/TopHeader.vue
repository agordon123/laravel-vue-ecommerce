...
<header class="flex justify-between items-center p-3 h-14 shadow bg-white">
  ...
  <Menu as="div" class="relative inline-block text-left">
    <MenuButton class="flex-items center">
      <img src="https://randomuser.me/api/portraits/men/1.jpg" class="rounded-full w-8 mr-2" alt="Portrait">
      <small>Adam Gordon</small>
...
import LogoutIcon from '@heroicons/vue/20/solid';
